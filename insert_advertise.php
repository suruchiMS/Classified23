...
if (isset($_POST['submit_btn'])) {
    ...
    $views = 0;
    $color =
        $query = "INSERT INTO advertise1 (client_id,category_id,sub_category_id,description,title,start_date,ad_category_id,expiry_date,featured,status,views) VALUES('$clientid','$categoryid','$subcategoryid','$description','$title','$startdate',' $adcatid','$expirydate','$featured','$status',0)";
