                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                ...
                                                $query = "Select * from advertise1 where client_id = '$clientid' ";
                                                            ...
                                                            while ($row = mysqli_fetch_array($data)) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        $sql3 = "select * from config where ad_category_id = '$adcategoryid'";
                                                                    ...
                                                                    <!-- <td><a
                                                                            href="edit_advertise.php?id=<?php echo $row['adv_id']; ?>"><i
