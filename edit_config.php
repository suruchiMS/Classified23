...
$select = "Select * from config where ad_category_id='$adcategoryid'";
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <form class="form-material" method="post"
                                                        action="submit_config.php?id=<?php echo $row['ad_category_id']; ?>">
                                                        <div class=" form-group form-default row">
                                                            <div class="col-sm-6">
                                                                <input value="<?php echo $row['advertise_category'] ?>"
                                                                    type="text" class="form-control" name="advcat"
                                                                    placeholder="Advertisement Category" required>
                                                                <span class="form-bar"></span>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <input value="<?php echo $row['adv_limit'] ?>"
                                                                    type="text" class="form-control" name="advlimit"
