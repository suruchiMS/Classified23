                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <form class="form-material" method="post"
                                                        ...
                                                        <div class=" form-group form-default row">
                                                                    ...
                                                                    if ($result2) {
                                                                        while ($row2 = mysqli_fetch_array($data2)) {
                                                                            ...
                                                                            <option value="<?php echo $row2['category_id'] ?>"
                                                                                <?php
                                                                                if ($row2['category_id'] == $categoryid) {
                                                                                    echo "selected";
                                                                                }
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <select name="SubCategory" id="SubCategory">
                                                                    ...
                                                                    $sql3 = "select * from sub_category where category_id='$categoryid'";
                                                                    ...
                                                                    if ($result3) {
                                                                        while ($row3 = mysqli_fetch_array($data3)) {
                                                                            ?>
                                                                            <option
                                                                                value="<?php echo $row3['subcategory_id'] ?>"
                                                                                <?php
                                                                                if ($row3['subcategory_id'] == $subcategoryid) {
                                                                                    echo "selected";
                                                                                }
                                                        ...
                                                        <div class=" form-group form-default row">
                                                            <div class="col-sm-6">
                                                                <input value="<?php echo $row['title']; ?>" type="text"
                                                        ...
                                                        <div class=" form-group form-default row">
                                                            <div class="col-sm-6">
                                                                <textarea name="description" rows="5" cols="60"
                                                                    ...
                                                                    placeholder="Please write 200 characters description"><?php echo $row['description']; ?></textarea>
                                                        ...
                                                        <div class=" form-group form-default row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <label for="featured">Is Featured</label><br>
